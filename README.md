...
<div class="container mx-auto px-4 py-8 max-w-6xl">
  <!-- Header with animated gradient (optional) -->
  <div class="text-center mb-12">
    <div class="inline-block p-2 bg-indigo-100 rounded-full mb-4">
    ...
    <div class="mt-6 flex flex-wrap justify-center gap-2">
      <span class="badge"><i class="fab fa-python mr-1"></i>Python 3.10</span>
      <span class="badge bg-green-600"><i class="fab fa-node-js mr-1"></i>Node.js 14+</span>
      <span class="badge bg-purple-600"><i class="fas fa-bolt mr-1"></i>FastAPI</span>
      <span class="badge bg-yellow-600"><i class="fas fa-microphone-alt mr-1"></i>TTS Library</span>
      <span class="badge bg-red-600"><i class="fab fa-gpu mr-1"></i>GPU Ready</span>
    </div>
  </div>
  ...
  <div class="grid md:grid-cols-2 gap-6 mb-12">
    ...
    <div class="bg-white rounded-xl shadow-md p-6 hover:shadow-lg transition">
      <div class="flex items-center mb-3">
        <i class="fas fa-file-alt text-indigo-500 text-2xl mr-2"></i>
    ...
    <div class="bg-white rounded-xl shadow-md p-6 hover:shadow-lg transition">
      <div class="flex items-center mb-3">
        <i class="fas fa-stream text-indigo-500 text-2xl mr-2"></i>
    ...
    <div class="bg-white rounded-xl shadow-md p-6 hover:shadow-lg transition">
      <div class="flex items-center mb-3">
        <i class="fas fa-microphone text-indigo-500 text-2xl mr-2"></i>
  ...
  <div class="bg-white rounded-xl shadow-md p-6 mb-12">
    <div class="flex items-center mb-4">
      <i class="fas fa-cogs text-indigo-600 text-2xl mr-2"></i>
      <h2 class="text-2xl font-bold text-gray-800">Technical Stack</h2>
    </div>
    <div class="grid md:grid-cols-2 gap-8">
      <div>
        <h3 class="font-semibold text-lg text-indigo-600 mb-2"><i class="fas fa-server mr-1"></i> Backend</h3>
      ...
      <div>
        <h3 class="font-semibold text-lg text-indigo-600 mb-2"><i class="fas fa-laptop-code mr-1"></i> Frontend</h3>
        <ul class="list-disc list-inside text-gray-700 space-y-1">
  ...
  <!-- Project Structure (exact from your ls) -->
  <div class="bg-white rounded-xl shadow-md p-6 mb-12">
    <div class="flex items-center mb-4">
      <i class="fas fa-folder-tree text-indigo-600 text-2xl mr-2"></i>
      <h2 class="text-2xl font-bold text-gray-800">Project Structure</h2>
    </div>
    <pre class="bg-gray-800 text-gray-200 text-sm rounded-lg overflow-x-auto"><code>cypher-aibook/
...
└── README.md</code></pre>
  ...
  <div class="bg-white rounded-xl shadow-md p-6 mb-12">
    <div class="flex items-center mb-4">
      <i class="fas fa-play-circle text-indigo-600 text-2xl mr-2"></i>
      <h2 class="text-2xl font-bold text-gray-800">Setup & Running</h2>
    </div>
    <div class="space-y-5">
      <div>
        <h3 class="text-xl font-medium text-gray-800">1. Navigate to project</h3>
        <pre class="bg-gray-800 text-gray-200 text-sm"><code>cd /home/kecypher/Desktop/cypher-aibook</code></pre>
      </div>
      <div>
        <h3 class="text-xl font-medium text-gray-800">2. Install Python dependencies</h3>
...
pip install -r requirements.txt</code></pre>
      ...
      <div>
        <h3 class="text-xl font-medium text-gray-800">3. Install Node dependencies</h3>
        <pre class="bg-gray-800 text-gray-200 text-sm"><code>npm install</code></pre>
      </div>
      <div>
        <h3 class="text-xl font-medium text-gray-800">4. Download TTS models (automatic on first run)</h3>
      ...
      <div>
        <h3 class="text-xl font-medium text-gray-800">5. Start the servers</h3>
...
python run.py</code></pre>
  ...
  <div class="bg-white rounded-xl shadow-md p-6 mb-12">
    <div class="flex items-center mb-4">
      <i class="fas fa-hands-helping text-indigo-600 text-2xl mr-2"></i>
      <h2 class="text-2xl font-bold text-gray-800">Using the App</h2>
    </div>
    <div class="grid md:grid-cols-3 gap-4">
      <div class="flex items-start space-x-2">
        <i class="fas fa-keyboard text-indigo-500 mt-1"></i>
  ...
  <div class="bg-white rounded-xl shadow-md p-6 mb-12">
    <div class="flex items-center mb-4">
      <i class="fas fa-plug text-indigo-600 text-2xl mr-2"></i>
      <h2 class="text-2xl font-bold text-gray-800">API Endpoints (Backend)</h2>
    </div>
  ...
  <div class="bg-white rounded-xl shadow-md p-6 mb-12">
    <div class="flex items-center mb-4">
      <i class="fas fa-bug text-indigo-600 text-2xl mr-2"></i>
  ...
  <div class="bg-white rounded-xl shadow-md p-6 mb-12">
    <div class="flex items-center mb-4">
      ...
      <h2 class="text-2xl font-bold text-gray-800">Model Details</h2>
    </div>
